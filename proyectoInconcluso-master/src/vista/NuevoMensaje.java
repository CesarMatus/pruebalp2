...
public class NuevoMensaje extends javax.swing.JFrame {
     ...
     */
    public NuevoMensaje(BandejaEntrada be) {
        this.be = be; 
        initComponents(); 
        NuevoMensajeController nmc = new NuevoMensajeController(be, this , destinatarioCB);
        enviarButton.addActionListener(nmc);
    }
    ...
    public JComboBox<Usuario> getDestinatarioCB() {
    ...
    private javax.swing.JComboBox<Usuario> destinatarioCB;
